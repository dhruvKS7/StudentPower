...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center; text-transform: uppercase">SEVENTH GRADE</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="seventhMath.jsp">MATH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="seventhSocial.jsp">SOCIAL STUDIES</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="seventhEnglish.jsp">ENGLISH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="seventhScience.jsp">SCIENCE</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="seventhLanguage.jsp">FOREIGN LANGUAGES</a>
        </div>
        <br>
