...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center; text-transform: uppercase">FOURTH GRADE</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="fourthMath.jsp">MATH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="fourthSocial.jsp">SOCIAL STUDIES</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="fourthEnglish.jsp">ENGLISH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="fourthScience.jsp">SCIENCE</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="fourthLanguage.jsp">FOREIGN LANGUAGES</a>
        </div>
        <br>
