        ...
        <div class="row">
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    ...
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Energy</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Forces & motion</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Environmental interactions</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Astronomy</dt>
                </dl>
            </div>
        </div>
