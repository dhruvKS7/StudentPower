    ...
    <body onclick >
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl>
                    ...
                    <dt class="colText">Whole numbers:</dt>
                    <br>
                    <dd class="colText">- Place value</dd>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Operations with whole numbers:</dt>
                    <br>
                    <dd class="colText">- Addition, subtraction, multiplication, & division</dd>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Decimals:</dt>
                    <br>
                    <dd class="colText">- Converting between decimals & percentages</dd>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Fractions:</dt>
                    <br>
                    <dd class="colText">- Add and subtract fractions and mixed numbers</dd>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Measurements:</dt>
                    <br>
                    <dd class="colText">- Units of measurement</dd>
                    <dd class="colText">- Applying formulas to metric measures</dd>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Geometry:</dt>
                    <br>
                    <dd class="colText">- Real-life applications</dd>
                    <dd class="colText">- Three-dimensional figures</dd>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Probability:</dt>
                    <br>
                    <dd class="colText">- Concept understanding</dd>
                    <dd class="colText">- Mean, median, mode, & range</dd>
                    <dd class="colText">- Bar graphs, Venn diagrams, & line graphs</dd>
                </dl>
            </div>
        </div>
        ...
        <div class="buttonDiv">
            <form action="classRefresh" method="POST">
                <input type="text" name="subject" value="math" style="visibility: hidden; display: none">
                <input type="text" name="grade" value="fifth" style="visibility: hidden; display: none">
