...
<html>
    <head>
        <title>Eighth Social Studies</title>
        <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl style="text-align: center">
                    ...
                    <br>
                    <dt class="colText">Creation of the US government</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Early years of the American republic</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Explain and understand the purpose of government</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Identify different types of democracies</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Medieval society</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">The renaissance</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">The crusades' effect on Europe</dt>
                </dl>
            </div>
        </div>
