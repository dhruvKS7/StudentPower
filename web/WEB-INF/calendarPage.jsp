<%-- 
    ...
    Created on : Jun 16, 2020, 3:04:00 PM
...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center">SCHEDULE SESSION</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <h2 style="text-align: center">Don't forget to let your tutor know what you want to be tutored in through the Calendly notes section!</h2>
        <iframe style="min-width: 90%; margin-left: 5%; margin-right: 5%; height: 500px;" src="${calendarLink}" title="Calendly"></iframe>
        <br>
        <br>
    </body>
</html>