    ...
    <body onclick >
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl>
                    ...
                    <dt class="colText">Learning to write articles:</dt>
                    <br>
                    <dd class="colText">- How-To articles</dd>
                    <dd class="colText">- Informative articles</dd>
                    <dd class="colText">- News articles</dd>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText" style="text-align: center">Writing short stories</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText" style="text-align: center">Writing poetry</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Analyzing persuasive texts</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Accurate apostrophe use</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Spelling conventions</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Strategies to edit your writing</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Using infinitives and participles</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Using parts of speech correctly</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Utilizing varying sentence types</dt>
                </dl>
            </div>
        </div>
        ...
        <div class="buttonDiv">
            <form action="classRefresh" method="POST">
                ...
                <input type="text" name="grade" value="eighth" style="visibility: hidden; display: none">
