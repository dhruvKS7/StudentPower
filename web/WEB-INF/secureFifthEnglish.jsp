        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl style="text-align: center">
                    ...
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Use of synonyms, antonyms, homonyms, prefixes, suffixes, homophones, & idioms</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Greek & Latin roots</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt style="text-align: center" class="colText">Process skills</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Enhance reading comprehension through:</dt>
                    <br>
                    <dd class="colText">- Summarizing</dd>
                    <dd class="colText">- Visualizing</dd>
                    <dd class="colText">- Clarifying</dd>
                    <dd class="colText">- Predicting</dd>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Summarizing</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Plot identification</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Main idea & theme recognition</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Compare and contrast</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Making inferences</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Author's intent</dt>
                </dl>
            </div>
        </div>
