<%-- 
    Document   : addClasses
    Created on : Jun 16, 2020, 10:47:55 AM
...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center">ADD CLASSES</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <h2 style="text-align: center">Click on the class to add it to your list</h2>
        <div>
                    ...
                    <tr>
                        <td>
                            <form action="addClass" method="POST">
                                <input style="max-width: 300px; max-height: 300px" type="image" src="${row.get(0)}" alt="${row.get(1)}"/>
