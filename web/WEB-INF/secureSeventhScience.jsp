    ...
    <body onclick >
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl style="text-align: center">
                    ...
                    <dt class="colText">Earth's structure</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Geological processes</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The atmosphere, weather, and climate</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The solar system and stars</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Oceans and the water cycle</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Plate tectonics</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The universe and galaxies</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Living things</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Plant & animal cells</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Characteristics of unicellular and multicellular organisms</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Classifications</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Structure and function of human organ systems</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Structure and function of plants</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Basic physics & chemistry</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Physical and chemical changes</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Atoms and elements</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The periodic table</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Motion, gravity, and energy</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Properties of waves</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Light and optics</dt>
                </dl>
            </div>
        </div>
        ...
        <div class="buttonDiv">
            <form action="classRefresh" method="POST">
                <input type="text" name="subject" value="science" style="visibility: hidden; display: none">
                <input type="text" name="grade" value="seventh" style="visibility: hidden; display: none">
