...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center; text-transform: uppercase">MY SCHEDULING</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="calendarPage" method="POST">
                                <input class="hero__button" type="submit" style="font-size: 20px" value="Schedule">
                                <input style="display: none; visibility: hidden" type="text" name="user" value="${row.get(0)}">
                            </form>
                        </td>
                    </tr>
