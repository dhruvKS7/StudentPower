...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center">CHILD INFO</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <br>
        <div style="text-align: center">
            <a href="#popup1" class="hero__button" style="font-size: 20px">ADD CHILD</a>
        </div>
        <br>
        <br>
        <div>
            <table border="3" width="90%" style="margin-left: 5%; margin-right: 5%">
                <tr>
                    <!--[[max, saligramdhruv@gmail.com, Max, Potter, 8, noavatar.png, working.html, Math, Social-Science, Science, English, Spanish]]-->
                    <th width="10%">Avatar</th>
                    <th width="20%">Username</th>
                    <th width="15%">Name</th>
                    <th width="30%">Email</th>
                    <th width="20%">Current Classes</th>
                    <th width="5%">View Files</th>
                </tr>
                ...
                <c:forEach var="row" items="${dbData}">
                    <tr>
                        ...
                        <td>
                            <a href="${row.get(6)}" target="_blank">View Files</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
            ...
            <div class="popup">
                ...
                <div class="content">
                    ...
                    <form action="addChild" method="POST">
                        CHILD'S USER NAME: <br><input type="text" name="childUserName"/>
                        <br>
                        <br>
                        CHILD'S PASSWORD:<br> <input type="password" name="childPassword"/>
                        <br>
                        <br>
