...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center; text-transform: uppercase">${classNameText}</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <div style="text-align: center">
            <form action="subjectRefresh" method="POST">
                ...
                <select name="subjects" style="font-size: 20px">
                ...
                <br>
                <br>
                <input type="submit" class="hero__button" value="SEARCH" style="font-size: 20px">
            </form>
        </div>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="addTutor" method="POST">
                                <input class="hero__button" type="submit" style="font-size: 20px" value="ADD">
                                <input type="text" style="display: none; visibility: hidden" name="user" value="${row.get(0)}">
                            </form>
                        </td>
                    </tr>
