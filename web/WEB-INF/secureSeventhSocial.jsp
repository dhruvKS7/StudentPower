...
<html>
    <head>
        <title>Seventh Social Studies</title>
        <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl style="text-align: center">
                    ...
                    <br>
                    <dt class="colText">The age of exploration</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">English colonization</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">The American Revolution</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Creation of the U.S. government</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Early years of the republic</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">American growth & expansion</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Reform movements</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The Civil War</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Immigration & industry</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">World War I</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The Great Depression</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">World War II</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">The Cold War</dt>
                    <hr style="background-color: black; height: 2px; border: none">
                    <dt class="colText">Modern America</dt>
                </dl>
            </div>
        </div>
