...
<html>
    ...
    <body onclick >
        ...
        <br>
        <h2 class="whyus__title" style="text-align: center; text-transform: uppercase">SECOND GRADE</h2>
        <br>
        <div style="height: 1px; background-color: black; margin: 0.5rem 0;"></div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="secondMath.jsp">MATH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="secondSocial.jsp">SOCIAL STUDIES</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="secondEnglish.jsp">ENGLISH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="secondScience.jsp">SCIENCE</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="secondLanguage.jsp">FOREIGN LANGUAGES</a>
        </div>
        <br>
