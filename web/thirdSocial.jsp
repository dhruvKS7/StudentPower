...
<html>
    <head>
        <title>Third Social Studies</title>
        <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="column" style="background-color:#aaa;">
                ...
                <dl style="text-align: center">
                    ...
                    <br>
                    <dt class="colText">Vikings</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">The world in spatial terms</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#bbb;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Exploration of the Americas</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">North American colonization</dt>
                </dl>
            </div>
            ...
            <div class="column" style="background-color:#ccc;">
                ...
                <dl style="text-align: center">
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Rural, suburban & urban regions</dt>
                    <br>
                    <hr style="background-color: black; height: 2px; border: none">
                    <br>
                    <dt class="colText">Citizenship & governments</dt>
                </dl>
            </div>
        </div>
        <br>
