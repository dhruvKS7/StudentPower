...
<html>
    ...
    <body onclick >
        ...
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="firstMath.jsp">MATH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="firstSocial.jsp">SOCIAL STUDIES</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="firstEnglish.jsp">ENGLISH</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="firstScience.jsp">SCIENCE</a>
        </div>
        <br>
        <div class="linkNotSecure">
            <a class="hero__button" style="font-size: 30px; display: inline-block; width: 100%; text-align: center" href="firstLanguage.jsp">FOREIGN LANGUAGES</a>
        </div>
        <br>
